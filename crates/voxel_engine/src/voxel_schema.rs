...
impl BlockSchema {
    ...
    pub fn set_local(&mut self, x: usize, y: usize, z: usize, block: crate::chunk::BlockId) {
        let idx = x
            + y * crate::chunk::CHUNK_SIZE
            + z * crate::chunk::CHUNK_SIZE * crate::chunk::CHUNK_SIZE;
    ...
    fn world_to_local(&self, pos: IVec3) -> Option<(usize, usize, usize)> {
        ...
        if local.x >= 0
            && local.x < crate::chunk::CHUNK_SIZE as i32
            && local.y >= 0
            && local.y < crate::chunk::CHUNK_SIZE as i32
            && local.z >= 0
            && local.z < crate::chunk::CHUNK_SIZE as i32
        {
